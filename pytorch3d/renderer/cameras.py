...
class OpenGLPerspectiveCameras(TensorProperties):
    ...
    def get_projection_transform(self, **kwargs) -> Transform3d:
        ...
        # NOTE: In OpenGL the camera space postive z direction is  the
        # world space negative z direction. Therefore the sign of the z needs
        # to be set to -1.0.
        # In the torch3d examples so far the world and camera z axis are
        # aligned so z sign is 1.0.
        # TODO: change to OpenGL world/camera coordinate frames?
        z_sign = 1.0
...
class OpenGLOrthographicCameras(TensorProperties):
    ...
    def get_projection_transform(self, **kwargs) -> Transform3d:
        ...
        ones = torch.ones((self._N), dtype=torch.float32, device=self.device)
        # NOTE: z direction in openGL is negative as RH coordinate system
        # TODO: define coordinate system correctly in documentation!
        z_sign = +1.0
